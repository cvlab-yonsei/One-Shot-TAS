...
--save_checkpoint_path 'checkpoint-lr000182-feature-align-all-not-clip-check-grad-8-40-' --save_log_path './log/supernet_lr000182_feature_align_all_not_clip_check_grad_8_40.log'
