...
# --change_qk --relative_position --mode super --dist-eval --cfg ./experiments/supernet/supernet-T.yaml --epochs 40 --warmup-epochs 0 \
# --resume '/OUTPUT_PATH/checkpoint-lr0002-feature-align-all-1.pth' --output /OUTPUT_PATH --batch-size 128 \
# --save_checkpoint_path 'checkpoint-lr0002-feature-align-all-not-clip-' --save_log_path './log/supernet_lr0002_feature_align_all_not_clip.log'
