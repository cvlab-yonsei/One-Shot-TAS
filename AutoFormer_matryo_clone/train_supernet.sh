...
# python -m torch.distributed.launch --nproc_per_node=8 --use_env supernet_train_load_matryo_216_240_BCinit.py --data-path '/dataset/ILSVRC2012' --gp \
# --change_qk --relative_position --mode super --dist-eval --cfg ./experiments/supernet/supernet-T.yaml --epochs 40 --warmup-epochs 0 \
...
# --save_checkpoint_path 'checkpoint-lr0002-BC-no-A-40epoch-ABC-' --save_log_path './log/supernet_lr0002_bc_no_a_40epoch_ABC.log'
...
# python -m torch.distributed.launch --nproc_per_node=8 --use_env supernet_train_load_matryo_216_240_2.py --data-path '/dataset/ILSVRC2012' --gp \
# --change_qk --relative_position --mode super --dist-eval --cfg ./experiments/supernet/supernet-T.yaml --epochs 40 --warmup-epochs 0 \
# --resume '/OUTPUT_PATH/checkpoint-original-only192216-training-23.pth' --output /OUTPUT_PATH --batch-size 128 \
...
# --save_checkpoint_path 'checkpoint-original-small-400-500-12-123-25-384-440-1-0-lr00005-allfreeze-tuple-' --save_log_path './log/supernet_original-small-400-500-12-123-25-384-440-1-0_lr00005_allfreeze_tuple.log'

python -m torch.distributed.launch --nproc_per_node=8 --use_env supernet_train_load_matryo_576_624.py --data-path '/dataset/ILSVRC2012' --gp \
--change_qk --relative_position --mode super --dist-eval --cfg ./experiments/supernet/supernet-B.yaml --epochs 20 --warmup-epochs 0 \
--resume '/OUTPUT_PATH/checkpoint-original-base-200-500-12-123-25.pth' --output /OUTPUT_PATH --batch-size 128 \
--save_checkpoint_path 'checkpoint-original-base-200-500-12-123-1-1-lr000005-allfreeze-tuple-' --save_log_path './log/supernet_checkpoint-original-base-200-500-12-123-25-1-1_lr000005_allfreeze_tuple.log'
...
# python -m torch.distributed.launch --nproc_per_node=8 --use_env supernet_train_load_matryo_216_240.py --data-path '/dataset/ILSVRC2012' --gp \
# --change_qk --relative_position --mode super --dist-eval --cfg ./experiments/supernet/supernet-T.yaml --epochs 40 --warmup-epochs 0 \
# --resume '/OUTPUT_PATH/checkpoint-original-only192216-training-300-460-23.pth' --output /OUTPUT_PATH --batch-size 128 \
# --save_checkpoint_path 'checkpoint-original-only192216-training-300-460-216-1-0-240-1-1-lr00005-allfreeze-' --save_log_path './log/supernet_original_only192216_training_300_460_216_1-0_240_1-1_lr00005_allfreeze.log'
