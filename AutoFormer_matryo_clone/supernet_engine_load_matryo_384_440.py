...
def sample_configs_curriculum(choices, epoch=None, curriculum_epoch=None):
    ...
    if epoch is None:
        ...
        # embed_dim_choice = random.choice([384, 440])
        embed_dim_choice = random.choices([384, 440], weights=[1, 1])[0] # (1, 3) -> (1, 1)
...
def evaluate(data_loader, model, device, amp=True, choices=None, mode='super', retrain_config=None, epoch=None):
    ...
    if mode == 'super':
        ...
        # config = {'layer_num': 14, 'mlp_ratio': [4.0, 4.0, 3.5, 4.0, 3.5, 3.5, 3.5, 3.5, 4.0, 4.0, 3.5, 3.5, 3.5, 3.5], 'num_heads': [3, 3, 4, 4, 3, 3, 4, 4, 4, 4, 4, 3, 4, 3], 'embed_dim': [440, 440, 440, 440, 440, 440, 440, 440, 440, 440, 440, 440, 440, 440]}
        # if epoch % 2 == 1:
        config = {'layer_num': 13, 
