...
from supernet_engine_original import train_one_epoch, evaluate
...
sys.stdout = open('./log/supernet_original-400epoch2.log', 'w')
...
def main(args):
    ...
    for epoch in range(args.start_epoch, args.epochs):
        ...
        if args.output_dir:
            ...
            checkpoint_paths = [output_dir / ('checkpoint-original-config-test' + str((epoch+1)//20) + '.pth')]
