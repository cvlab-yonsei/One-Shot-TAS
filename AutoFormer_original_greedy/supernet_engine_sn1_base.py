...
def get_group(param_count):
    ...
    if param_count < 42e6:
        return 0  # ~6M
    elif 42e6 <= param_count < 54e6:
        return 1  # 6M~7M
    elif 54e6 <= param_count < 66e6:
        return 2  # 7M~8M
    elif 66e6 <= param_count < 76e6:
        return 3  # 8M~9M
    else:
        return 4  # 9M~
...
def train_one_epoch(model: torch.nn.Module, criterion: torch.nn.Module,
    ...
    if mode == 'retrain':
        ...
        with open('candidate_pool_greeze_tas_460_m2500k1250_sn_linear08_no_duplicate_droppath01(base).pkl', 'wb') as f:
            pickle.dump(candidate_pool, f)

        print("candidate_pool이 candidate_pool_greeze_tas_460_m2500k1250_sn_linear08_no_duplicate_droppath01(base).pkl 파일로 저장되었습니다.")
