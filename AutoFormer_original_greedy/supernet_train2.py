...
from supernet_engine2 import train_one_epoch, evaluate
...
sys.stdout = open('./log/supernet_greedy_spectral_norm_400ep_bottomk.log', 'w')
...
def main(args):
    ...
    for epoch in range(args.start_epoch, args.epochs):
        ...
        # Adjust pool sampling probability gradually (e.g., linear increase to 0.8)
        ...
        if args.output_dir:
            ...
            checkpoint_paths = [output_dir / ('checkpoint-sn-400-bottom-' + str((epoch+1)//20) + '.pth')]
