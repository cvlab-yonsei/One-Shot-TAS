...
sys.stdout = open('./log/supernet_original_only192216_training_test_400_500_12_123_399.log', 'w')
...
def main(args):
    ...
    for epoch in range(args.start_epoch, args.epochs):
        ...
        if args.output_dir:
            ...
            checkpoint_paths = [output_dir / ('checkpoint-original-only192216-training-400-500-' + str((epoch+1)//20) + '.pth')]
