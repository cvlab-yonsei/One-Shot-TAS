...
sys.stdout = open('./log/supernet_original_small_400_500_12_123_399.log', 'w')
...
def main(args):
    ...
    for epoch in range(args.start_epoch, args.epochs):
        ...
        if args.output_dir:
            ...
            checkpoint_paths = [output_dir / ('checkpoint-original-small-400-500-12-123-' + str((epoch+1)//20) + '.pth')]
